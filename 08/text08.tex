...
\begin{center}
  % Unhandled or unsupported graphics:
\includegraphics[width=17.006cm]{textbook-img007.png}
...
\begin{center}
  % Unhandled or unsupported graphics:
\includegraphics[width=15.074cm]{textbook-img008.png}
...
\item \ \ \ \ with urllib.request.urlopen(url) as response:
...
39行目では、最初の{\textless}table class={\textquotedbl}common-list-entries
amedas-table-entries{\textquotedbl}{\textgreater}を探して取り出しています。

41行目では、取り出した{\textless}table{\textgreater}タグから{\textless}tr{\textgreater}タグを２行分取り出しています。

46行目で、値の説明（日時、気温、降水などの文字列）
...
\item \ \ \ \ \# {\textless}table class={\textquotedbl}common-list-entries amedas-table-entries{\textquotedbl}{\textgreater}{\textless}/table{\textgreater}の中の{\textless}tr{\textgreater}{\textless}/tr{\textgreater}を2行分取り出す
...
\begin{center}
  % Unhandled or unsupported graphics:
\includegraphics[width=9.668cm]{textbook-img040.eps}
...
\begin{center}
  % Unhandled or unsupported graphics:
\includegraphics[width=15.118cm]{textbook-img042.png}
...
\begin{center}
  % Unhandled or unsupported graphics:
\includegraphics[width=17.006cm]{textbook-img051.png}
...
\begin{center}
  % Unhandled or unsupported graphics:
\includegraphics[width=11.409cm]{textbook-img052.png}
...
\begin{center}
  % Unhandled or unsupported graphics:
\includegraphics[width=13.873cm]{textbook-img055.png}
...
\begin{center}
  % Unhandled or unsupported graphics:
\includegraphics[width=16.016cm]{textbook-img062.png}
...
{\upshape
\includegraphics[width=12.631cm]{textbook-img067.png}
\newline
...
\begin{center}
  % Unhandled or unsupported graphics:
\includegraphics[width=13.707cm]{textbook-img068.png}
