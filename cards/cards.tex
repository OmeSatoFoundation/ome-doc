...
\newcommand\cover[1]{
    \begin{tikzpicture}
        ...
        \path (0mm,0mm) rectangle (\width mm,\height mm);
%        \draw [line width=0.97mm] (0.5mm,0.5mm) rectangle (\width mm-0.5mm,\height mm-0.5mm);
        \node [font=\Huge\gtfamily\bfseries, align=center] (Title) at (.5*\width mm,.5*\height mm) {#1年度\\子どもIT未来塾\\スタンプラリーカード};
...
\newcommand\typeJP{
    \begin{tikzpicture}
        ...
        \path (0mm,0mm) rectangle (\width mm,\height mm);
        \node [font=\huge\gtfamily\bfseries, align=left] (Title) at (2.5 mm + 32mm , \height mm - 7mm - 12mm) {タイピング\\スタンプラリーカード};
...
\newcommand\typeEN{
    \begin{tikzpicture}
        ...
        \path (0mm,0mm) rectangle (\width mm,\height mm);
        \node [font=\huge\gtfamily\bfseries, align=left] (Title) at (2.5 mm + 32mm , \height mm - 7mm - 12mm) {タイピング(英語)\\スタンプラリーカード};
        \draw [blue, very thick] (\typevmargin mm, 8 mm) -- (\width mm - \typevmargin mm, 8 mm) -- (\width mm-\typevmargin mm, 8 mm+\typegrid mm) -- (\typevmargin mm, 8 mm+\typegrid mm) -- cycle;
        \foreach \i in {1,...,4} {
            \tikzmath{
                \x = \typevmargin + \i * \typegrid;
...
%\tencards{\StampCard{第1回例題チェック}{ccimages/hydrangea.png}{ccimages/yellow-umbrella.eps}{1}{19}{27}{true}{2}}% 2枚目裏
%\tencards{\StampCard{第1回問題チェック}{ccimages/hydrangea.png}{ccimages/yellow-umbrella.eps}{1}{1}{12}{false}{1}}% 3枚目表
%\tencards{\StampCard{第1回問題チェック}{ccimages/hydrangea.png}{ccimages/yellow-umbrella.eps}{1}{13}{24}{true}{2}}% 3枚目裏
...
\tencards{\StampCard{第6回問題チェック}{ccimages/nashi.jpg}{ccimages/donguri.jpg}{6}{1}{7}{false}{1}}
%\tencards{\StampCard{第7回例題チェック}{ccimages/ice.png}{ccimages/suika.png}{7}{1}{7}{false}{1}}
\tencards{\StampCard{第7回問題チェック}{ccimages/ice.png}{ccimages/suika.png}{7}{1}{6}{false}{1}}
...
\tencards{\StampCard{第6回問題チェック}{ccimages/nashi.jpg}{ccimages/donguri.jpg}{6}{7}{15}{true}{2}}
%\tencards{\StampCard{第7回例題チェック}{ccimages/ice.png}{ccimages/suika.png}{7}{8}{12}{true}{2}}
\tencards{\StampCard{第7回問題チェック}{ccimages/ice.png}{ccimages/suika.png}{7}{8}{11}{true}{2}}
