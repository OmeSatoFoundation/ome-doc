  ...
  % 番号を振る
    ...
    \foreach \iy in {1,...,\numhlines}{
        ...
        \foreach \ix in {1,...,\nextx}{  
            ...
            \node (\iy-\ix) at (\x mm, \y mm) {1-\cellcnt};
    }
  }
    % complete stamp
    % draw ()--()--()--()
...
\end{tabular}
\begin{tabular}{@{}c@{}c}
\StampCard{第3回問題チェック}{ccimages/publicdomainq-0055442njyucl.png}{ccimages/sun.png}{3}{1}{18}{false}{1} & \StampCard{第3回問題チェック}{ccimages/publicdomainq-0055442njyucl.png}{ccimages/sun.png}{3}{19}{21}{true}{2} \\
\StampCard{第4回例題チェック}{ccimages/fireworks.png}{ccimages/publicdomainq-0044202onqfss.png}{3}{1}{9}{false}{1} & \StampCard{第4回例題チェック}{ccimages/fireworks.png}{ccimages/publicdomainq-0044202onqfss.png}{2}{10}{16}{true}{2} \\
\end{tabular}
}
\newcommand\printall{
\tencards{\cover{2023}}
...
\tencards{\StampCard{第4回例題チェック}{ccimages/fireworks.png}{ccimages/publicdomainq-0044202onqfss.png}{3}{1}{9}{false}{1}}
\tencards{\typeEN}
...
\tencards{\StampCard{第4回例題チェック}{ccimages/fireworks.png}{ccimages/publicdomainq-0044202onqfss.png}{2}{10}{16}{true}{2}} 
}
\begin{document}
\printall
\end{document}
