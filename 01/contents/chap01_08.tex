...
\noindent%
  ...
  \begin{minipage}[t]{0.55\columnwidth}
    ...
    \vbox to 0pt{\vskip-3mm
      % \includegraphics[keepaspectratio, height=55mm]{text01-img/textbook-img245.png}
      \includegraphics[keepaspectratio, width=0.8\linewidth]{text01-img/textbook-img245.png}
    \vss}
    \vspace{50mm}
  \end{minipage}
%
...
\begin{minipage}[t]{0.55\columnwidth}
  \centering
  \vbox to 0pt{\vskip-3mm
    % \includegraphics[keepaspectratio, height=80mm]{text01-img/textbook-img246.png}
    \includegraphics[keepaspectratio, width=0.8\linewidth]{text01-img/textbook-img246.png}
  \vss}
  \vspace{95mm}
\end{minipage}
%
...
\begin{minipage}[t]{0.55\columnwidth}
  \centering
  \vbox to 0pt{\vskip-3mm
    \includegraphics[keepaspectratio, width=0.8\linewidth]{text01-img/textbook-img247.png}
  \vss}
  \vspace{40mm}
\end{minipage}
%
