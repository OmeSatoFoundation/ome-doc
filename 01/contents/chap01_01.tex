                  ...
                  \begin{figure}[h]
                    ...
                    \begin{minipage}{5.228cm}
                      {\upshape
                        ...
                        \newline
                        Figure {\refstepcounter{Figure}\theFigure\label{seq:refFigure12}}:
                        パスワード管理}
                    \end{minipage}
                  \end{figure}
                  \item
   ...
   \clearpage           
    \item
        アップデートの確認をしよう
                \begin{itemize}
                  \item
                      次の画面に進むとソフトウェアアップデートを求めらるのでNextを押してアップデートを行いましょう。アップデートが始まるとロード画面が現れてloadingの文字とゲージが表示されるので終わるまで待ちましょう。
                  \item
                      アップデートを行わない場合にはSkipボタンを押すことで次の画面に遷移します。Figure~\ref{seq:refFigure18}
                      \begin{figure}[h]
                        \centering
                        \begin{minipage}{5.228cm}
                          {\upshape
