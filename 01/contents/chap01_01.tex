...
\clearpage
  \item
      ...
      \end{itemize}
          ...
          \begin{itemize}   
                        \item
                            \refstepcounter{Question}\theQuestion 次の文章の\ruby{間違}{まちが}っている部分を訂正してください。また{間違}{まちが}っている部分が無い場合は×を記入してください。
                        ...
                        \item
                            \refstepcounter{Question}\theQuestion 次の文章で正しいものには○を、\ruby{誤}{あやま}ってるものには×を記入してください。
                            \begin{enumerate}[label=\textbf{(\arabic*)}]
                              ...
                              \begin{tabular}{|c|}
                                ...
                                \end{table}
                        \item
                            \refstepcounter{Question}\theQuestion 次のパスワードは\ruby{安全性}{あんぜんせい}が高いパスワードには○低いパスワードには×を記入しなさい。
                            \begin{enumerate}[label=\textbf{(\arabic*)}]
