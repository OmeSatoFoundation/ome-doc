...
\begin{figure}[hb]
  ...
  \begin{minipage}{15.801cm}
    {\upshape
      \includegraphics[width=\linewidth]{text01-img/textbook-img140.png}
      \caption{ホームページ作成全体図}
    }
  \end{minipage}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=0.9\linewidth]{text01-img/textbook-img143.png}
    \caption{ブラウザのタイトル表示}
    \label{fig:1.4.4}
\end{figure}
  ...
  \noindent%
    \begin{minipage}{0.45\linewidth}
      \includegraphics[width=0.9\linewidth]{text01-img/textbook-img1040.png}\\
      \textcircled{\scriptsize{1}} %
    ...
    \vspace{20pt}
    \begin{minipage}{0.45\linewidth}
      \includegraphics[width=0.9\linewidth]{text01-img/textbook-img1041.png}\\
      \textcircled{\scriptsize{2}} %
      「アプリケーションの\ruby{選択}{せんたく}」ウィンドウがでるので、「アクセサリ」をダブルクリックします
    \end{minipage}
    \begin{minipage}{0.45\linewidth}
      \includegraphics[width=0.9\linewidth]{text01-img/textbook-img1042.png}\\
      \textcircled{\scriptsize{3}} %
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{text01-img/textbook-img147.png}
  \caption{ファイルの保存}
  \label{fig:1.4.7}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{text01-img/textbook-img149.png}
  \caption{リロード}
  \label{fig:1.4.8}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{text01-img/textbook-img152.png}
  \caption{タイトルを変更した結果}
  \label{fig:1.4.9}
\end{figure}
...
\begin{figure}[htbp]
  ...
  % \mbox{ }\\
  \includegraphics[width=0.7\textwidth]{text01-img/textbook-img156.png}
...
\noindent%
\begin{minipage}{0.45\linewidth}
  \includegraphics[width=0.9\linewidth]{text01-img/textbook-img164.png}\\
  \textcircled{\scriptsize{1}} %
  Picturesをダブルクリックします
\end{minipage}
\hfill
\vspace{20pt}
\begin{minipage}{0.45\linewidth}
  \includegraphics[width=0.9\linewidth]{text01-img/textbook-img163.png}\\
  \textcircled{\scriptsize{2}} %
  使いたい\ruby{画像}{がぞう}の上で右クリックして、コピーを選択したあとで、赤枠の上矢印をクリックします
\end{minipage}
%
\begin{minipage}{0.45\linewidth}
  \includegraphics[width=0.9\linewidth]{text01-img/textbook-img167.png}\\
  \textcircled{\scriptsize{3}} %
  01フォルダをダブルクリックします
\end{minipage}
\hfill
\vspace{20pt}
\begin{minipage}{0.45\linewidth}
  \includegraphics[width=0.9\linewidth]{text01-img/textbook-img168.png}\\
  \textcircled{\scriptsize{4}} %
  右クリックして\ruby{貼}{は}り付けを\ruby{選択}{せんたく}します
\end{minipage}
%
\begin{minipage}{0.45\linewidth}
  \includegraphics[width=0.9\linewidth]{text01-img/textbook-img169.png}\\
  \textcircled{\scriptsize{5}} %
...
\vspace{20pt}
\begin{minipage}{0.45\linewidth}
  \includegraphics[width=0.9\linewidth]{text01-img/textbook-img166.png}\\
  \textcircled{\scriptsize{6}} %
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{text01-img/textbook-img178x.png}
  \caption{好きな食べ物ランキング}
  \label{fig:1.4.19}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{text01-img/textbook-img182x.png}
  \caption{ランキングの表示}
  \label{fig:1.4.20}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{text01-img/textbook-img182xx.png}
  \caption{ぶどうを追加した表示例}
  \label{fig:1.4.20x}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\textwidth]{text01-img/textbook-img187.png}
  \caption{色の見本}
  \label{fig:1.4.21}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{text01-img/textbook-img185.png}
  \caption{日記の例}
  \label{fig:1.4.22}
\end{figure}
...
\begin{minipage}{0.36\linewidth}
  \centering
  \includegraphics[width=0.95\linewidth]{text01-img/textbook-img190x.png}
  \vspace{1cm}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.4\textwidth]{text01-img/textbook-img193x.png}
  \caption{便利なリンク}
  \label{fig:1.4.24}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.45\textwidth]{text01-img/textbook-img196.png}
  \caption{URLを選択}
  \label{fig:1.4.25}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.4\textwidth]{text01-img/textbook-img197.png}
  \caption{URLのコピー}
  \label{fig:1.4.26}
\end{figure}
...
\begin{minipage}{0.36\linewidth}
  \centering
  \includegraphics[width=0.5\linewidth]{text01-img/textfig_1001.png}
\end{minipage}
\bigskip
...
\begin{minipage}[t]{0.36\linewidth}
  \centering
  \includegraphics[width=0.7\linewidth]{text01-img/textbook-img204x.png}
\end{minipage}
\bigskip
...
\begin{minipage}{0.3\linewidth}
  \centering
  \includegraphics[width=0.9\linewidth]{text01-img/textfig_1002.png}
\end{minipage}
...
% \begin{minipage}[t]{0.36\linewidth}
%   \centering
%   \includegraphics[width=0.7\linewidth]{text01-img/textfig_1002.png}
% \end{minipage}
