...
\noindent%
  ...
  \begin{minipage}[t]{0.55\columnwidth}
    ...
    \vbox to 0pt{\vskip-3mm
      \includegraphics[keepaspectratio, height=55mm]{text01-img/textbook-img206.png}
    \vss}
    \vspace{60mm}
  \end{minipage}
%
...
\begin{minipage}[t]{0.55\columnwidth}
  \centering
  \vbox to 0pt{\vskip-3mm
    \includegraphics[keepaspectratio, height=40mm]{text01-img/textbook-img208.jpg}
  \vss}
  \vspace{45mm}
\end{minipage}
%
...
\begin{minipage}[t]{0.55\columnwidth}
  \centering
  \vbox to 0pt{\vskip-3mm
    \includegraphics[keepaspectratio, height=35mm]{text01-img/textbook-img207x.png}
  \vss}
  \vspace{35mm}
\end{minipage}
