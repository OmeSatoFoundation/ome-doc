...
\begin{description}
    \item \textgt{\bf \ \ 横方向の表示倍率=0.0〜(1.0) : 横方向の表示倍率(\ruby{実数}{じっ|すう})}
    \item \textgt{\bf \ \ 縦方向の表示倍率=0.0〜(1.0) : 縦方向の表示倍率(\ruby{実数}{じっ|すう})}
    \item \textgt{\bf \ \ 回転角度=0.0〜(0.0) : 回転角度(\ruby{実数}{じっ|すう})}
\end{description}
