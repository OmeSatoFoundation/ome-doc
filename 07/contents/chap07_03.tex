...
\begin{minipage}[b]{0.8\textwidth}
	\begin{enumerate}
		...
		\begin{center}
			\includegraphics[width=0.8\textwidth]{text07-img/ome7-img034.png}
		\end{center}
...
\begin{enumerate}
  \item
    \begin{wrapfigure}{r}{0.9\textwidth}
      \vspace{-\baselineskip}
      \includegraphics[width=\linewidth]{text07-img/ome7-img035.png}
    \end{wrapfigure}%
  ...
  \item
    \begin{wrapfigure}{r}{0.9\textwidth}
      \vspace{-\baselineskip}
      \includegraphics[width=\linewidth]{text07-img/ome7-img036.png}
    \end{wrapfigure}%
...
\clearpage
  ...
  \item
    \begin{wrapfigure}{r}{0.9\textwidth}
      \vspace{-\baselineskip}
      \includegraphics[width=\linewidth]{text07-img/ome7-img037.png}
    \end{wrapfigure}%
