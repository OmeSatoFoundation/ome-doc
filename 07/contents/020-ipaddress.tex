...
\clearpage\subsection*{\bfseries 1−3　グローバルIPアドレスとローカルIPアドレス}
...
\clearpage
\subsection*{\theExercise IPアドレスを調べてみよう\label{E:checkIP}}
ターミナルにコマンド”hostname -\texttt{I}”を入力し、自分のラズベリーパイのローカルIPアドレスを確認しよう
...
{\bfseries 調べた自分のラズベリーパイのIPアドレスを書こう}
...
{\bfseries グループの友達のIPアドレスも教えてもらって書こう}
