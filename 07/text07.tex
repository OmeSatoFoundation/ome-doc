...
\vspace{16mm} \\%
\underline{\begin{minipage}{\linewidth}#1：\end{minipage}}\leavevmode \\
}
...
\centering
\includegraphics[width=11.024cm,height=5.436cm]{ome7-img003}
...
\centering
\includegraphics[width=11.412cm,height=5.786cm]{ome7-img004.png}
\flushleft
...
\centering
\includegraphics[width=14.566cm,height=7.696cm]{ome7-img007.png}

\centering
\includegraphics[width=14.52cm,height=7.682cm]{ome7-img008.png}
\flushleft
...
どれかしらのラズベリーパイからwebサイトへの要求があり、ルータを経由してインターネットに接続します。そのあと、インターネットから要求のあったwebサイトの情報がルータにいきます。ここで問題が発生します。それはいったいのどのラズベリーパイの要求であったのかルータがわからないのです。僕らが、勝手にラズベリーパイ１号機、ラズベリーパイ２号機、ラズベリーパイ３号機と名前をつけて判断していても、そのことはルータはわかりません。そこでIPアドレスというものを使います。
...
\centering
\includegraphics[width=14.233cm,height=7.0cm]{ome7-img016.png}
\flushleft
...
\centering
\includegraphics[width=16.609cm,height=8.043cm]{ome7-img021.png}

\centering
\includegraphics[width=16.496cm,height=7.895cm]{ome7-img022.png}
\flushleft
...
\centering
\includegraphics[width=16.843cm,height=7.756cm]{ome7-img023.png}
...
\centering
\includegraphics[width=15.004cm,height=8.213cm]{ome7-img026.png}
\flushleft
...
\centering
\includegraphics[width=13.051cm,height=7.856cm]{ome7-img027}
\flushleft
...
\centering
\includegraphics[width=11.924cm,height=6.509cm]{ome7-img028.png}
\flushleft
...
\centering
\includegraphics[width=11.352cm,height=6.38cm]{ome7-img029}
\flushleft
...
\centering
\includegraphics[width=8.176cm,height=4.72cm]{ome7-img046.png}
\textbf{・アンケートフォーム}\\
\includegraphics[width=6.1cm,height=5.801cm]{ome7-img047.png}
\flushleft
...
\centering
\includegraphics[width=16.574cm,height=5.152cm]{ome7-img051.png}
\flushleft
