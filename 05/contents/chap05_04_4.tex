...
exec命令は、\code{exec “コマンド”}とターミナルのコマンドを指定します。ここでのコマンドは先ほどターミナルで実行した\code{irsend SEND\_ONCE \textcolor{red}{fan onoff}}です。\code{\textcolor{red}{fan}}はリモコンの名前、\code{\textcolor{red}{onoff}}は信号の名前でした。\code{\textcolor{red}{fan}}と\code{\textcolor{red}{onoff}}は自分で設定ファイルに書いた名前に変えましょう。\\
