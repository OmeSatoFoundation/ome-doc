...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.5\hsize]{../../asset/image/textbook/text05-img012.png}
...
% \begin{figure}[h]
%   \begin{center}
%     \includegraphics[scale=0.6]{../../asset/image/textbook/text05-img013.png}
...
\begin{figure}[H]
  \begin{minipage}[t]{0.48\columnwidth}
    \centering
    \includegraphics[width=0.8\hsize]{../../asset/image/textbook/text05-img014.jpg}
    \caption{４ピンケーブル}
  \end{minipage}
  \hspace{0.04\columnwidth} % ここで隙間作成
  \begin{minipage}[t]{0.48\columnwidth}
    \centering
    \includegraphics[width=0.8\hsize]{../../asset/image/textbook/text05-img015.jpg}
    \caption{３ピンケーブル}
  \end{minipage}
\end{figure}
