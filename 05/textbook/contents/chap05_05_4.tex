...
\begin{figure}[H]
  \begin{widerrows}
    ...
    \begin{minipage}[t]{\linewidth}
      \smallskip
        \centering
        \includegraphics[width=0.7\linewidth]{../../asset/image/textbook/text05-img046.png}
        \caption{傾斜センサーの内部}
        \smallskip
      \end{minipage}
    \\ \hline
...
\begin{figure}[H]
  \begin{widerrows}
    ...
    \begin{minipage}[t]{\linewidth}
      \smallskip
        \centering
        \includegraphics[width=0.5\linewidth]{../../asset/image/textbook/text05-img018.png}
        \caption{傾斜センサー}
        \smallskip
      \end{minipage} &
      回路記号 & 
      ...
      \smallskip
        \centering
        \includegraphics[width=0.5\linewidth]{../../asset/image/textbook/text05-img047.png}
        \caption{傾斜センサーの回路図}
        \smallskip
      \end{minipage}\\ \hline
    \end{tabular}
