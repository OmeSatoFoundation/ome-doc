...
\begin{center}
  \begin{minipage}[b]{0.45\linewidth}
    \begin{figure}[H]
      \centering
      \includegraphics[keepaspectratio, scale=0.6]{../../asset/image/textbook/text05-img004.png}
      \caption{Faboのシールド}
      \label{fig4}
    \end{figure}
  \end{minipage}
  \begin{minipage}[b]{0.45\linewidth}
    \begin{figure}[H]
      \centering
      \includegraphics[keepaspectratio, scale=0.6]{../../asset/image/textbook/text05-img005.png}
      \caption{Faboのブリック}
      \label{fig5}
    \end{figure}
  \end{minipage}
...
\begin{enumerate}
  ...
  \begin{minipage}[b]{0.4\linewidth}
    \begin{figure}[H]
      \centering
      \includegraphics[width=.8\hsize]{../../asset/image/textbook/fabo_and_cable_rearview.jpg}
  ...
  \begin{minipage}[b]{0.4\linewidth}
    \begin{figure}[H]
      \centering
      \includegraphics[width=.8\hsize]{../../asset/image/textbook/fabo_and_cable_sideview.png}
...
\\
  %\begin{minipage}[b]{0.45\linewidth}
    \begin{figure}[H]
      \centering
      \includegraphics[width=.4\hsize]{../../asset/image/textbook/fabo_connected_to_rpi400.jpg}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=.4\hsize]{../../asset/image/textbook/sb_on_fabo_connected_to_rpi400.jpg}
    \caption{センサーボードとFaBoのシールドの接続}
  \end{figure}
  \item LEDをケーブルとつなげましょう。奥までコネクタを押しこんでください。\\
  \begin{figure}[H]
    \centering
    \includegraphics[width=.4\hsize]{../../asset/image/textbook/text05-img008.jpg}
    \caption{Faboのブリックとケーブルの接続}
  \end{figure}
  \item シールドとケーブルをつなげましょう。今回はGPIO23のところにつなげます。このときも奥までコネクタを押しこんでください。\\
  \begin{figure}[H]
    \centering
    \includegraphics[width=.4\hsize]{../../asset/image/textbook/led_brk_on_fabo_with_sb_zoomed.jpg}
  ...
  \begin{figure}[H]
    \begin{minipage}[t]{0.45\columnwidth}
      \centering
      \includegraphics[width=.8\hsize]{../../asset/image/textbook/text05-img010.jpg}
      \caption{ケーブルのツメ}
      白い部分の下の方を押します。
    \end{minipage}
    ...
    \begin{minipage}[t]{0.45\columnwidth}
      \centering
      \includegraphics[width=.8\hsize]{../../asset/image/textbook/text05-img011.jpg}
      \caption{ケーブルのツメの押し方}
