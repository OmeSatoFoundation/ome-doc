...
\begin{figure}[htb]
\begin{center}
    \includesvg[width=1.0\linewidth]{../../asset/image/textbook/smartphone_sensors.svg}
...
\begin{figure}[htbp]
  \begin{minipage}[b]{0.5\linewidth}
    \centering
    \includegraphics[keepaspectratio, scale=0.5]{../../asset/image/textbook/text05-img002.png}
    \caption{デジタル信号の例}
    \label{fig2}
  \end{minipage}
  \begin{minipage}[b]{0.5\linewidth}
    \centering
    \includegraphics[keepaspectratio, scale=0.5]{../../asset/image/textbook/text05-img003.png}
    \caption{アナログ信号の例}
    \label{fig3}
  \end{minipage}
\end{figure}
