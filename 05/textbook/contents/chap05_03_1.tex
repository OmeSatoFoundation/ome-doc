...
\begin{table}[H]
  \begin{widerrows}
		...
		\end{minipage} & 
			...
			\smallskip
				\centering
				\includegraphics[width=\linewidth]{../../asset/image/textbook/text05-img016.png}
				\smallskip
			\end{minipage} &
		...
		\end{minipage} & 
			...
			\smallskip
				\centering
				\includegraphics[width=0.8\linewidth]{../../asset/image/textbook/text05-img017.png}
				\smallskip
			\end{minipage} &
		...
		\end{minipage} & 
			...
			\smallskip
				\centering
				\includegraphics[width=0.8\linewidth]{../../asset/image/textbook/text05-img028.png}
				\smallskip
			\end{minipage} &
		...
		\end{minipage} & 
			...
			\smallskip
				\centering
				\includegraphics[width=0.8\linewidth]{../../asset/image/textbook/text05-img018.png}
				\smallskip
			\end{minipage} &
			\pageref{tilt}\\ \hline   
		\end{tabular}
  ...
  \begin{widerrows}
		\begin{tabular}{|p{\colA}|p{\colB}|p{\colC}|p{\colD}|p{\colE}|}
			...
			\begin{minipage}[t]{\linewidth}
				\smallskip
				\centering
				\includegraphics[width=0.8\linewidth]{../../asset/image/textbook/text05-img019.jpg}
				\smallskip
			\end{minipage} &
			...
			\begin{minipage}[t]{\linewidth}
				\smallskip
				\centering
				\includegraphics[width=0.8\linewidth]{../../asset/image/textbook/text05-img020.jpg}
				\smallskip
			\end{minipage} &
			...
			\begin{minipage}[t]{\linewidth}
				\smallskip
				\centering
				\includegraphics[width=0.8\linewidth]{../../asset/image/textbook/text05-img021.jpg}
				\smallskip
			\end{minipage} &
			...
			\begin{minipage}[t]{\linewidth}
				\smallskip
				\centering
				\includegraphics[width=0.8\linewidth]{../../asset/image/textbook/text05-img022.jpg}
				\smallskip
			\end{minipage} &
  ...
  \begin{widerrows}
		\begin{tabular}{|p{\colA}|p{\colB}|p{\colC}|p{\colD}|p{\colE}|}
			...
			\begin{minipage}[t]{\linewidth}
				\smallskip
				\centering
				\includegraphics[width=0.8\linewidth]{../../asset/image/textbook/text05-img023.jpg}
				\smallskip
			\end{minipage} &
			...
			\begin{minipage}[t]{\linewidth}
				\smallskip
				\centering
				\includegraphics[width=0.8\linewidth]{../../asset/image/textbook/text05-img024.png}
				\smallskip
			\end{minipage} &
			\pageref{light}\\ \hline
			...
			\begin{minipage}[t]{\linewidth}
				\smallskip
				\centering
				\includegraphics[width=0.8\linewidth]{../../asset/image/textbook/text05-img025.png}
				\smallskip
			\end{minipage} &
			\pageref{oled}\\ \hline
		\end{tabular}
