...
\begin{description}
\item[● \texttt{cat}\textvisiblespace \underline{ファイル}$\cdots$ ]\mbox{}\\
\underline{ファイル}$\cdots$に書かれている\ruby{内容}{ない|よう}を\ruby{表示}{ひょう|じ}します。
\end{description}
\begin{itemize}
...
\begin{description}
\item[● \texttt{mv}\textvisiblespace \underline{ファイルやディレクトリ}$\cdots$\textvisiblespace \underline{移動先ディレクトリ}]\mbox{}\\
\underline{ファイルやディレクトリ}$\cdots$を\underline{移動先ディレクトリ}に移動します。
\end{description}
\begin{itemize}
