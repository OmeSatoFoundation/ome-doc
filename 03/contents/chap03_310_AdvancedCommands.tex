...
\begin{tcolorbox}[title=\useOmetoi]
    \begin{enumerate}
        ...
        \addquiz{cat \textasciitilde/03/rensyu/kokugo/syosetsu.txt | tail -n \fbox{数字1} | head -n \fbox{数字2} \\ syosetsu.txtの下から3行目を表示するように \fbox{数字1} と \fbox{数字2} を埋めて、コマンドを実行しましょう。}
    \end{enumerate}
\end{tcolorbox}
