...
\begin{lstlisting}[caption=\textasciitilde/.bashaliasesの書き方1, label=bashAliasesGrammar1]
alias 名前='コマンド'
alias name='command'
            :
            :
...
\begin{lstlisting}[caption=\textasciitilde/.bashaliasesの読込, label=sourceBashAliases]
