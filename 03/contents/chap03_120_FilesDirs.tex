...
\addquiz{カレントディレクトリが /home/pi/Video/ のとき、ひとつ上のディレクトリはどれでしょうか。}
\addquiz{カレントディレクトリが /home/pi/ のとき、ひとつ下のディレクトリはどれでしょうか。４つあります。}
\addquiz{カレントディレクトリが /home/pi/Desktop/ のとき、ひとつ上のディレクトリはどれでしょうか。}
\addquiz{カレントディレクトリが \textasciitilde /Desktop のとき、ひとつ下のディレクトリはどれでしょうか。}
\end{enumerate}
\end{tcolorbox}
