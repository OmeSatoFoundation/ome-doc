...
Juliusはうまく言葉を\ruby{認識}{にん|しき}してくれましたか？おそらく、何度か\ruby{間違}{ま|ちが}えて認識したと思います。日本語には数多の単語がありますし、\ruby{似}{に}た発音の単語もあるので、それらを\ruby{完璧}{かん|ぺき}に認識することは\ruby{難}{むずか}しいのです。これを\ruby{解決}{かい|けつ}するために、次の節では「単語辞書」を登録してみます。\\
