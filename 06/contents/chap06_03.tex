...
\begin{figure}[H]
    \begin{center}
      \includegraphics[width=\linewidth]{images/pplug-volume_mic_context_menu.png}
      \caption{右上の USB PnP Sound Device はクリックしないよう注意！}
      \label{pplug-volume_mic_context_menu}
    \end{center}
\end{figure}

もしも押してしまった場合は、以下の手順に従ってください。
...
\begin{minipage}[ht]{0.23\linewidth}
    \begin{figure}[H]
        \begin{center}
            \includegraphics[width=\linewidth]{images/pplug-volume_speaker_context_menu.png}
...
\begin{minipage}[ht]{0.23\linewidth}
    \begin{figure}[H]
        \begin{center}
            \includegraphics[width=\linewidth]{images/pplug-volume_device_profile_top.png}
            \caption{「デバイスプロファイル」ウィンドウを表示}
            \label{pplug-volume_device_profile_top}
        \end{center}
    \end{figure}
\end{minipage}
\begin{minipage}[ht]{0.23\linewidth}
    \begin{figure}[H]
        \begin{center}
            \includegraphics[width=\linewidth]{images/pplug-volume_device_profile_dialog_only_output.png}
...
\begin{minipage}[ht]{0.23\linewidth}
    \begin{figure}[H]
        \begin{center}
            \includegraphics[width=\linewidth]{images/pplug-volume_device_profile_dialog_inout.png}
