...
4行目から7行目までは\ruby{復習}{ふく|しゅう}です。mes命令で文字を\ruby{表示}{ひょう|じ}させています。\\
9行目からが新しい命令です。\\
...
\begin{enumerate}
        \addex{「本日は青天なり」と読み上げるようにプログラムを書き変えて、sunny.hspという名前で \textasciitilde /06/に\ruby{保存}{ほ|ぞん}し、実行しましょう。\\ヒント：jtload "子どもIT\ruby{未来塾}{み|らい|じゅく}", 0をかきかえます。}
